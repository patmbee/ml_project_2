...
def investment_recommendation(risk_level):
    ...
    if risk_level.lower()  == 'none':
        recommendation_result = '100% buy of (QQQ)'
    elif risk_level.lower()  == 'low':
        recommendation_result = '20% buy of (QQQ)'
    elif risk_level.lower()  == 'medium':
        recommendation_result = '40% buy of (QQQ)'
    elif risk_level.lower()  == 'high':
        recommendation_result = '60% buy of (QQQ)'
...
def recommend_portfolio(intent_request):
    ...
    return close(intent_request['sessionAttributes'],
                 ...
                 {'contentType': 'PlainText',
                  'content': 'The machine learning model is providing a buy signal today, given your risk level - {}. We recommend this investment: {}. Thank you, {}, for using RoboAdvisor. '.format(input_risk_level, recommendation_result, input_first_name)})
